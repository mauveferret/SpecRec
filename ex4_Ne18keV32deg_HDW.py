...
# choose data files
spectra_path = os.getcwd()+os.sep+"raw_data"+os.sep+"ex4_sim_Ne18keV32deg_HDW"
...
SCD.create_conc_plots(datas, data_cnv, data_simple_deconv, data_numeric_deconv, conc_element_name="H", y_max=81, error_max=30) 
